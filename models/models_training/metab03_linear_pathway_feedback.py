...
PARAMS = {
    ...
    # NEW: integral feedback / homeostatic control on Pyr
...
def dYdt(t, Y):
    ...
    # Enzyme synthesis repressed by R (use nonnegative R in repression term)
    R_eff = max(R, 0.0)
...
if __name__ == "__main__":
    ...
    plt.title("metab03 v4 (homeostatic integral feedback on Pyr)")
    plt.legend()
    plt.tight_layout()
