...
# ============================================================================
# Family 5 (Gene Regulatory Circuits) — Canonical genetic toggle switch
# Two repressors mutually inhibit each other (A ⟂ B and B ⟂ A).
# Includes mRNA and protein layers to ensure low-copy vs high-copy multiscale structure.
# ============================================================================
...
PARAMS = {
    ...
    # Inducers (bounded relaxation to setpoints; do not require time-dependent forcing)
    # Biological interpretation: slowly varying inducer pools (e.g., IPTG/aTc) that reduce repressor activity.
...
if __name__ == "__main__":
    ...
    plt.title("grn04_toggle_switch (canonical mutual repression toggle)")
    plt.legend()
    plt.tight_layout()
