...
# Saturable output node: Z_protein drives an enzymatic product P with Michaelis–Menten saturation + product decay.
# Multiscale: fast mRNAs, slower proteins, abundant substrate pool, low-copy transcription factors.
