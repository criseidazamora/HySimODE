...
# Model 34: stochosc01_brusselator
# Canonical 2-species Brusselator oscillator (limit-cycle for B > 1 + A^2).
# ======================================================================
...
# Choose ICs away from the fixed point (X*=A, Y*=B/A) to reveal limit cycle clearly.
Y0 = [
    0.20,  # X
    5.00   # Y
]
