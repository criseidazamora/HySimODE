...
# -----------------------------------------------------------------------------
# dYdt kept for compatibility; accepts keyword p=...
# -----------------------------------------------------------------------------
def dYdt(t, Y, p=None):
    if p is None:
        p = PARAMS
...
# -----------------------------------------------------------------------------
# Auditor expects a *_odes function; keep model_odes wrapper
# -----------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    plt.title(f"{MODEL_NAME} trajectories")
    plt.xlabel("time")
    plt.ylabel("concentration / counts")
