...
# ============================================================================
# Family 1 (Metabolism) — Linear metabolic chain with mass-action kinetics
# ============================================================================
...
PARAMS = {
    ...
    # Enzyme-catalyzed step (still mass-action: E_lim + F6P -> FBP)
    ...
    # Regulator-mediated modulation of effective catalysis (mild inhibition)
    # (Biologically: product-responsive regulator reduces effective catalytic throughput)
