...
# ============================================================================
# Family 4 (Deterministic Oscillators) — Rosenzweig–MacArthur (standard model)
# Logistic prey + Holling type II predation, tuned for robust oscillations
# ============================================================================
...
#
# Tuned to yield visible oscillations within 500–2000 min without near-extinction.
PARAMS = {
    # Rosenzweig–MacArthur core
    "r": 0.030,        # /min prey intrinsic growth
    "K": 20000.0,      # molecules carrying capacity (enrichment -> oscillatory regime)
    ...
    # Mild auxiliary bounded nutrient (NO ramp): relaxes to baseline
...
def dYdt(t, Y):
    ...
    # Mild control on attack rate (kept small to avoid quenching/warping)
    ...
    # Waste: produced by consumption, weak clearance (not a strong sink on P/Z)
...
if __name__ == "__main__":
    ...
    plt.title("osc02_lotka_volterra_logistic (Rosenzweig–MacArthur, Holling-II; robust oscillations)")
    plt.legend()
    plt.tight_layout()
