# ============================================================================
# Family 7 (Stochastic Oscillators) — Activator–inhibitor oscillator with delayed inhibition
# stochosc03_activator_inhibitor.py
# Deterministic activator–inhibitor oscillator with activator auto-activation,
# delayed inhibitory feedback, sequestration dynamics, and metabolic resource coupling.
...
def make_plots(t, y):
    ...
    # Preview plot of all species trajectories
