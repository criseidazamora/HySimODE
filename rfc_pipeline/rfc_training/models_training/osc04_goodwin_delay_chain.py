...
# repression, linear degradation, and a five-step distributed delay chain.
# ============================================================================
import numpy as np
...
# Parameter regime supporting delayed oscillatory dynamics
PARAMS = {
    ...
    # Translation and distributed delay chain
...
# ===== INITIAL CONDITIONS ====================================================
# Initial conditions in a delayed-oscillation regime
Y0 = [
    85.0,     # mRNA
    7000.0,   # P0
    4200.0,   # P1
...
if __name__ == "__main__":
    ...
    plt.title("osc04_goodwin_delay_chain (5-step distributed delay)")
    plt.legend()
    plt.tight_layout()
