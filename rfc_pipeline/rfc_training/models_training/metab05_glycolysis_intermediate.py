# ============================================================================
# Family 1 (Metabolism) — Reduced glycolysis with feed-forward coupling 
# metab05_glycolysis_intermediate.py
# Metabolic pathway model combining smooth substrate conversion, ATP/ADP energy
# coupling, intermediate buffering, and FBP-mediated feed-forward activation of
# downstream pyruvate production within a regulated glycolytic regime.
# ============================================================================
...
PARAMS = {
    ...
    # Feed-forward activation of pyruvate production by FBP
    "K_FBP_PK": 800.0,
    "n_FBP_PK": 2.0,
...
def dYdt(t, Y):
    ...
    # Feed-forward activation of GAP→Pyr by FBP
...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.title("metab05_glycolysis_intermediate (FBP feed-forward activation)")
    plt.tight_layout()
    plt.savefig("metab05_glycolysis_intermediate_preview.png", dpi=220)
