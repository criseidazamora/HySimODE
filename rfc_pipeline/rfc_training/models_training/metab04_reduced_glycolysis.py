# ============================================================================
# Family 1 (Metabolism) — Reduced glycolysis with futile cycling 
# metab04_reduced_glycolysis.py 
# Reduced glycolytic model with ATP-coupled early steps, reversible sugar
# interconversion, and PFK regulation by ATP/ADP. A competing FBPase-like
# reverse flux creates a futile cycle between F6P and FBP, introducing
# energetic dissipation and altered ATP/ADP dynamics.
# ============================================================================
import numpy as np
...
PARAMS = {
    ...
    # Futile cycle: FBPase reverse flux from FBP to F6P
    # Biological interpretation: partial gluconeogenic activity associated with futile cycling
    "k_fbpase": 0.030,      # (/min)
    "K_fbpase": 800.0,      # (molecules)

    # ATP cost coupled to futile cycle activity
...
def dYdt(t, Y):
    ...
    # Futile cycle: FBPase-like reverse flux from FBP to F6P
...
if __name__ == "__main__":
    ...
    plt.title("metab04_reduced_glycolysis (futile cycle)")
    plt.legend()
    plt.tight_layout()
