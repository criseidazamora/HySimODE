# ============================================================================
# Family 5 (Gene Regulatory Circuits) — Asymmetric genetic toggle switch
# grn06_toggle_asymmetric.py
# Two-gene mutual repression circuit with strong Hill cooperativity and low basal leak.
# Mild transcriptional asymmetry biases the relative stability of the two states.
# Dynamic inducers reduce effective repressor activity while preserving bistable behavior.
# ============================================================================
...
PARAMS = {
    ...
    # Mild transcriptional asymmetry favoring A
    "alpha_mA": 6.2,
    "alpha_mB": 5.1,
    "alpha_leak": 0.01,

    # Repression thresholds and cooperativity (Hill repression)
    # Near-symmetric repression thresholds with mild asymmetry in transcriptional strength
    ...
    # Moderate basal inducer levels preserving effective repression strength
    "IndA0": 1400.0,
    "IndB0": 1400.0,
    "k_ind_relax": 0.0010,  # /min
}

# Default initial condition with a mild A-biased state
Y0 = [
    50.0,    # mA
    50.0,    # mB
    4000.0,  # pA
...
if __name__ == "__main__":
    ...
    # Deterministic solution used for micro-audit
    ...
    plt.title("grn06_toggle_asymmetric: default trajectory")
    plt.legend()
    plt.tight_layout()
    ...
    plt.xlabel("time [min]")
    plt.ylabel("molecules")
    plt.title("grn06_toggle_asymmetric")
    plt.legend()
    plt.tight_layout()
