# ============================================================================
# Family 2 (Signaling) — Three-layer MAPK cascade
# signal05_mapk_three_layer.py
# Simplified Raf–MEK–ERK signaling cascade with stimulus-driven Raf activation,
# MM-type phosphorylation/dephosphorylation of MEK and ERK, and explicit
# phosphatase pools for each downstream layer.
# ============================================================================
import numpy as np
