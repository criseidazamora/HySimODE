# ============================================================================
# Family 4 (Deterministic Oscillators) — Extended Lotka–Volterra predator–prey model
# osc01_lotka_volterra.py
# Predator–prey oscillator with a Lotka–Volterra core, coupled to buffered
# nutrient dynamics, waste accumulation, a low-copy controller, and predator
# damage/repair variables.
# ============================================================================
import numpy as np
...
# ===== PARAMETERS ============================================================
# Parameter regime supporting sustained predator–prey oscillations
PARAMS = {
    ...
    # Waste production and clearance
...
if __name__ == "__main__":
    ...
    plt.title("osc01_lotka_volterra (Lotka–Volterra-type oscillator)")
    plt.legend()
    plt.tight_layout()
