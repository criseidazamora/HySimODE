# ============================================================================
# Family 6 (Network Motifs / Multiscale) — Hybrid stochastic–deterministic enzyme module
# motif05_stochastic_enzyme_deterministic_substrate.py
# Hybrid model: low-copy enzyme expression represented by mean–variance
# dynamics with burst-like production, coupled to deterministic substrate and
# product pools. Free enzyme is sequestered by an inhibitor and drives
# saturable catalytic conversion of an abundant substrate into product.
# Multiscale structure: fast transcript dynamics, slower enzyme/regulator
# turnover, and large metabolic pools.
# ============================================================================
...
def dYdt(t, Y):
    ...
    # Noise scaling follows the production flux and enzyme abundance
...
if __name__ == "__main__":
    ...
    plt.title(f"{MODEL_NAME} (hybrid enzyme module)")
