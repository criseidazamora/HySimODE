# ============================================================================
# Family 2 (Signaling) — Three-layer MAPK cascade with ERK-mediated negative feedback
# signal06_mapk_three_layer_feedback.py
# Raf→MEK→ERK signaling cascade with stimulus-driven Raf activation, 
# Michaelis–Menten phosphorylation/dephosphorylation steps, 
# and an ERKp-induced feedback mediator that inhibits upstream Raf activation.
# ============================================================================
import numpy as np
