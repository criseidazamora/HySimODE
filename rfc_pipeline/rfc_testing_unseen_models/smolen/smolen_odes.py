...
#              --model models/concentration_adapter_hybrid.py --tfinal 500 --dt 0.01 --runs 1
#
...
# general compartment interface
compartment_indices = {
    "synapse": list(range(0, 10)) + [20, 21, 22],
    "dendrite": list(range(10, 20)),
}
...
# === Compartments (general interface for adapter) ===

compartment_indices = {
    "synapse": list(range(10)) + [20, 21, 22],
    "dendrite": list(range(10, 20))
}
