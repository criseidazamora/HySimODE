...
# - Mismo orden de variables que en tus scripts de Julia
# - Derivadas nombradas: dyrmr, dyem, ... para TODAS las variables
# - Solver: SciPy solve_ivp(method="BDF")
# - EPS rompe la simetría entre (g1, g2, g3) y (mg1, mg2, mg3) y (rmg1, rmg2, rmg3)
...
RTOL = 1e-6
ATOL = 1e-8
PLOT = True         # True para graficar g1,g2,g3
EPS  = 0.10          # asimetría determinista (0.0 → sin romper simetría)

# =========================
# Parámetros (warmUp1/2 .jl)
# =========================
...
# =========================================================
# WarmUp1 ODEs (22 vars)  [orden de warmUp1.txt]
...
# =========================================================
# WarmUp2 ODEs (25 vars) [orden de warmUp2.txt]
...
# =========================================================
# Host + Repressilator ODEs (31 vars) [orden del script Julia]
...
def main():
    ...
    # --- WarmUp2 inicial (25 vars) desde WarmUp1 (ver mapeo de warmUp1.txt → warmUp2.txt)
    (rmr, em, rmp, rmq, rmt, et, rmm, zmm, zmr, zmp, zmq, zmt,
    ...
    # --- y0 (31 vars) para Host+Repressilator, rompiendo simetría con EPS
    (rmr, em, rmp, rmq, rmt, rmg, et, rmm, zmm, zmr, zmp, zmq, zmt,
    ...
    # Devolver y0 (31 vars) y la solución del sistema final
    return y0, sol3

if __name__ == "__main__":
    y0, sol = main()
    print("y0 (31 vars) listo para tests. Primeros 6:", y0[:6])
